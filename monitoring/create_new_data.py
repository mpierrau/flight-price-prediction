...
def get_val_from_choice(
    valid_choices: list[Any], invalid_choices: list[Any], allow_invalid: bool = False
) -> Any:
    """
...
def get_total_stop(allow_invalid: bool = False) -> int:
    """Get number of stops"""
    return get_val_from_choice(range(5), range(6, 10), allow_invalid)
...
def get_day(allow_invalid: bool = False) -> int:
    ...
    return get_val_from_choice(range(1, 28), range(32, 100), allow_invalid)


def get_month(allow_invalid: bool = False) -> int:
    """Get number of month"""
    return get_val_from_choice(range(1, 13), range(13, 30), allow_invalid)


def get_year(allow_invalid: bool = False) -> int:
    """Get year. Future years are fine."""
    return get_val_from_choice(range(1990, 2050), range(-100, 0), allow_invalid)


def get_hour(allow_invalid: bool = False) -> int:
    """Get hour of day"""
    return get_val_from_choice(range(24), range(-15, 100), allow_invalid)


def get_minute(allow_invalid: bool = False) -> int:
    """Get minute of the hour"""
    return get_val_from_choice(range(60), range(60, 100), allow_invalid)
...
def get_price(allow_invalid: bool = False) -> int:
    ...
    invalid_values_minmax = (100000, 300000)
    r = (
